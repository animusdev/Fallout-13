...
// Почему гуночат не любит русские буквы? Да хуй его знает.

		message = replacetext(message, "\n", "<br>")
		message = replacetext(message, "\t", "&nbsp;&nbsp;&nbsp;&nbsp;")

		message = replacetext(message, "А", "&#1040;")
		message = replacetext(message, "Б", "&#1041;")
		message = replacetext(message, "В", "&#1042;")
		message = replacetext(message, "Г", "&#1043;")
		message = replacetext(message, "Д", "&#1044;")
		message = replacetext(message, "Е", "&#1045;")
		message = replacetext(message, "Ё", "&#1025;")
		message = replacetext(message, "Ж", "&#1046;")
		message = replacetext(message, "З", "&#1047;")
		message = replacetext(message, "И", "&#1048;")
		message = replacetext(message, "Й", "&#1049;")
		message = replacetext(message, "К", "&#1050;")
		message = replacetext(message, "Л", "&#1051;")
		message = replacetext(message, "М", "&#1052;")
		message = replacetext(message, "Н", "&#1053;")
		message = replacetext(message, "О", "&#1054;")
		message = replacetext(message, "П", "&#1055;")
		message = replacetext(message, "Р", "&#1056;")
		message = replacetext(message, "С", "&#1057;")
		message = replacetext(message, "Т", "&#1058;")
		message = replacetext(message, "У", "&#1059;")
		message = replacetext(message, "Ф", "&#1060;")
		message = replacetext(message, "Х", "&#1061;")
		message = replacetext(message, "Ц", "&#1062;")
		message = replacetext(message, "Ч", "&#1063;")
		message = replacetext(message, "Ш", "&#1064;")
		message = replacetext(message, "Щ", "&#1065;")
		message = replacetext(message, "Ъ", "&#1066;")
		message = replacetext(message, "Ы", "&#1067;")
		message = replacetext(message, "Ь", "&#1068;")
		message = replacetext(message, "Э", "&#1069;")
		message = replacetext(message, "Ю", "&#1070;")
