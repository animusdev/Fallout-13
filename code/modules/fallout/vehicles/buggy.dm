...
/obj/vehicle/fuel/motorcycle/buggy
	name = "dune buggy"
	desc = "<i>Ain't no place for fancy cars on the wasteland.<br>No place for classy brands.<br>Only the rusty and trusty death machines.<br>Only fuel and blood.</i>"
