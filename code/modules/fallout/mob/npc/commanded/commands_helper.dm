var/list/translit_symbols = list("а" = "a", "б" = "b", "в" = "v", "г" = "g", "д" = "d", "е" = "e", "Є" = "yo", "ж"= "j", "з" = "z", "и" = "i", \
 ...
 "ь" = "", "ъ" = "")
var/static/list/phrases_storage = list("attack" = "assault,sic,strike,rush,charge,bit,target,fuck,фас,мочи,вали,кус,цап,бей,атак,ебашь,штурм,уеб,хоп", "follow" = "come,to me,after,with,escort,convoy,chase,пиздуй,иди,сюда,ко мне,к ноге,р€дом,за мной,пров,конв,след,вперед", \
"stop" = "quit,leave,drop,freeze,pause,cease,layoff,хватит,стоп,остановись,харе,перестань,фу,нет,нельз€,брос,вольно,свобод", "stay" = "wait,hold,still,idle,сто€ть,стой,мест,не двигайс€", \
...
"legion" = "легион", "ncr" = "нкр", "raider" = "bandit,criminal,raid,gang,psych,insane,maniac,sadist,рейд,хулиг,банд,пахан,псих,шиз,мани,садист,содом", "enemy" = "foe,bad,bully,evil,danger,threat,monster,asshole,fag,traitor,villain,dick,douche,prick,spy,agent,враг,чуж,плох,зло,опас,угр,пред,шпи,враж,сволоч,муд,пидор", "friend" = "buddy,master,good,kind,ally,partner,друг,друз,добр,повел,хоз,хор,союз,пар", "pull" = "grab,bring,get,drag,fetch,take,haul,tow,deliver,rescue,save,help,апорт,тащи,неси,хват,возьми,вз€,заложи,спас,букс", "doge" = "dog,pup,hound,mongrel,pooch,bowwow,псин,пЄс,собак,кобел,щен,пса,волк", \
