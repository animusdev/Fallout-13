...
/mob/living/simple_animal/hostile/supermutant
	name = "super mutant"
	desc = "A huge, ugly mutant humanoid."
	...
	response_disarm = "tries to perform a kung fu move when its suddenly remembers that it's actually"
	response_harm = "hits"
	maxHealth = 300
	health = 300
	force_threshold = 15
...
/mob/living/simple_animal/pet/dog/mutant    //This is a supermutant, totally not a dog, and he is friendly
	name = "Brah Min"
	desc = "A huge, ugly mutant humanoid with a shovel full of brahmin feces.<br>He behaves totally insane and it seems he can speak English.<br>His only concern is his brahmins."
	icon = 'icons/fallout/mobs/supermutant.dmi'
	...
	health = 300
	speak_chance = 30
	speak = list("Hey you! These are my brahmins!", "And I say, HEYYEYAAEYAAAEYAEYAA! HEYYEYAAEYAAAEYAEYAA! I SAID HEY, what's going on?", "What do you want from my brahmins!?", "Me gonna clean brahmin poop again now!", "I love brahmins, brahmins are good, just poop much!", "Do not speak to my brahmins ever again, you hear!?", "Bad raiders come to steal my brahmins - I crush their heads with my brahmin poop shovel!", "Do not come to my brahmins! Do not touch my brahmins! Do not look at my brahmins!", "I'm watching you, and my brahmins watch too!", "Brahmins say moo, and I sau - hey, get your ugly face out of my way!")
	speak_emote = list("shouts", "yells")
