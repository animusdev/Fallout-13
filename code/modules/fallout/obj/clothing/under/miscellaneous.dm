...
/obj/item/clothing/under/f13/rag
	name = "torn rags"
	desc = "A shirt - or whatever it has become - made of ripped cloth.<br>It has been repeatedly soaked in sweat and has a bad smell.<br>Only the poorest of settlers, mostly the drug addicts, raiders, or slaves, would wear something like this."
	icon_state = "rag"
	item_state = "lgloves"
	item_color = "rag"
	can_adjust = 0
...
/obj/item/clothing/under/f13/tribal
	...
	desc = "A male outfit made of gecko hides.<br>It doesn't cover some parts of the body, but it's better than walking around naked..."
	icon_state = "tribal_m"
	item_state = "lgloves"
	item_color = "tribal_m"
	can_adjust = 0
...
/obj/item/clothing/under/f13/female/tribal
	...
	desc = "A female outfit made of gecko hides.<br>It doesn't cover some parts of the body, but it's better than walking around naked..."
	icon_state = "tribal_f"
	item_state = "lgloves"
	item_color = "tribal_f"
	can_adjust = 0
...
/obj/item/clothing/under/f13/settler
	name = "settler outfit"
	desc = "A crudely-made tan robe with a makeshift belt made from cloth.<br>Paired with worn grey pants."
	icon_state = "settler"
	item_state = "brownjsuit"
	item_color = "settler"
	can_adjust = 0
...
/obj/item/clothing/under/f13/doctor //Male version
	...
	desc = "A white t-shirt, a small brown satchel, and brown trousers with pouches attached to the belt.<br>Fitted for male Wastelanders."
	icon_state = "doctor_m"
	item_state = "brownjsuit"
	item_color = "doctor_m"
...
/obj/item/clothing/under/f13/female/doctor //Female version
	...
	desc = "A white t-shirt with brown trousers. There is a small brown satchel bag attached.<br>Fitted for female Wastelanders."
	icon_state = "doctor_f"
	item_state = "brownjsuit"
	item_color = "doctor_f"
	fitted = FEMALE_UNIFORM_TOP
...
/obj/item/clothing/under/f13/mercadv //Male version
	...
	desc = "A large leather jacket with torn-off sleeves, paired with a red sweater, a necklace made of three teeth, and a pair of brown leather pants.<br>There is also a rough leather bandolier for additional storage capacity.<br>Fitted for male Wastelanders."
	icon_state = "merca_m"
	item_state = "bl_suit"
	item_color = "merca_m"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
...
/obj/item/clothing/under/f13/female/merccharm //Female version
	...
	desc = "A ripped and torn blue female business suit. Despite its condition, it still gives ladies a professional look.<br>Fitted for female Wastelanders."
	icon_state = "mercc_f"
	item_state = "bl_suit"
	item_color = "mercc_f"
	fitted = FEMALE_UNIFORM_TOP
...
/obj/item/clothing/under/f13/mechanic
	...
	desc = "A worn jumpsuit, made of soft-blue colored cloth, with old machine oil stains on it.<br>A long time ago it could have belonged to a repair mechanic."
	icon_state = "mechanic"
...
/obj/item/clothing/under/f13/caravaneer
	...
	desc = "A striped brown shirt, with a pair of dark blue pants on suspenders.<br>This type of outfit is commonly worn by caravaneers and travelers."
...
/obj/item/clothing/under/f13/trader
	...
	desc = "An outfit commonly worn by various Wastelanders. Despite how unoriginal it is, it still looks pretty badass!"
	icon_state = "trader"
	item_state = "bl_suit"
	item_color = "trader"
	can_adjust = 0
...
/obj/item/clothing/under/f13/merchant
	...
	desc = "An outfit commonly worn by various Wastelanders, mostly wandering traders and merchants at markets.<br>Can I get a 10% discount?"
	icon_state = "merchant"
	item_state = "brownjsuit"
	item_color = "merchant"
	can_adjust = 0
...
/obj/item/clothing/under/f13/worn
	name = "worn outfit "
	desc = "A worn khaki shirt without any buttons left, and a ragged pair of jeans.<br>It may seem like a bad outfit choice at first, but there are Wastelanders out there who would kill for any clothing at all."
	icon_state = "worn"
	item_state = "brownjsuit"
	item_color = "worn"
	can_adjust = 0
...
/obj/item/clothing/under/f13/vault/v13 //The Legend is here.
	...
	desc = "The regulation clothing worn by the vault dwellers of Vault-Tec vaults. It's made of sturdy leather.<br>This jumpsuit has a yellow number 13 on the back."
	icon_state = "vault13"
	item_color = "vault13"

/obj/item/clothing/under/f13/vault/v113
	name = "Vault 113 jumpsuit"
	desc = "The regulation clothing worn by the vault dwellers of Vault-Tec vaults. It's made of sturdy leather.<br>This jumpsuit has a yellow number 113 on the back."
	icon_state = "vault113"
	item_color = "vault113"

/obj/item/clothing/under/f13/vault/v21
	name = "Vault 21 jumpsuit"
	desc = "The regulation clothing worn by the vault dwellers of Vault-Tec vaults. It's made of sturdy leather.<br>This jumpsuit has a yellow number 21 on the back."
	icon_state = "vault21"
	item_color = "vault21"

/obj/item/clothing/under/f13/vault/v42
	name = "Vault 42 jumpsuit"
	desc = "The regulation clothing worn by the vault dwellers of Vault-Tec vaults. It's made of sturdy leather.<br>This jumpsuit has a yellow number 42 on the back.<br>After looking for a little while, you start to question Life, the Universe, and Everything."
	icon_state = "vault42"
	item_color = "vault42"

/obj/item/clothing/under/f13/followers
	name = "followers outfit "
	desc = "A white shirt with a pair of dark brown cargo pants, commonly worn by Followers of the Apocalypse.<br><i>Nihil boni sine labore.</i>"
...
/obj/item/clothing/under/f13/combat
	name = "combat uniform"
	desc = "An ancient combat uniform that fell out of use around the time of the Great War."
	icon_state = "combat"
	item_state = "bl_suit"
	item_color = "combat"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
...
/obj/item/clothing/under/f13/enclave_officer
	...
	desc = "A standard Enclave officer's uniform.<br>The outer layer is made of a sturdy material designed to withstand the harsh conditions of the Wasteland."
...
/obj/item/clothing/under/f13/ncr_officer
	name = "officer uniform"
	desc = "A standard NCR officer's uniform.<br>Embroided New California Republic flag patches adorn both sleeves."
	icon_state = "enclave_o"
	item_state = "lb_suit"
	item_color = "enclave_o"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
...
/obj/item/clothing/under/f13/ncr
	name = "overcoat"
	desc = "A regular NCR uniform that consists of a khaki field jacket with bellowed hip pockets and khaki breeches."
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
...
/obj/item/clothing/under/f13/recon
	name = "recon armor"
	desc = "Intended to serve as the under-armor of the T-45d power armor, the recon armor is a vacuum-sealed asbestos jumpsuit covering the entire body.<br>Attached to it is an interface and mounts for power armor.<br>Its purpose is twofold - it allows the user to actually operate the armor, and it protects soft tissue from heat and from moving parts inside the suit."
	icon_state = "recon"
	item_state = "rig_suit"
	item_color = "recon"
...
/obj/item/clothing/under/f13/villain //Doubles as Gang Leader primary uniform for extra villainy
	...
	desc = "There is something evil in this suit. Only a villain would wear something like this."
	icon_state = "villain"
...
/obj/item/clothing/under/f13/roboticistalt
	...
	desc = "A slim-fit black jumpsuit with bright reinforced orange seams. Great for industrial work."
...
/obj/item/clothing/under/female/queen
	...
	desc = "A splendid purple dress made of silk. It's decorated with a golden necklace."
...
/obj/item/clothing/under/female/blackskirt
	name = "black skirt"
	desc = "A slim-fit black skirt. Very fancy!"
...
/obj/item/clothing/under/female/schoolgirl
	...
	desc = "Wow! This is just like one of those Japanese animes!"
...
/obj/item/clothing/under/female/dress_rd
	...
	desc = "Feminine fashion for the style-conscious RD.<br>Its fabric provides minor protection from biological contaminants."
	icon_state = "dress_rd"
	item_state = "lb_suit"
	item_color = "dress_rd"
...
/obj/item/clothing/under/female/roboticist
	desc = "A roboticist's jumpsuit with a womens' cut. Great for industrial work."
...
/obj/item/clothing/under/female/redeveninggown
	...
	desc = "Fancy dress for bar singers."
...
/obj/item/clothing/under/female/dress_orange
	name = "orange dress"
	desc = "A fancy orange gown for those who like to show some leg."
...
/obj/item/clothing/under/female/blackjumpskirt
	...
	desc = "A black jumpskirt, size zero."
