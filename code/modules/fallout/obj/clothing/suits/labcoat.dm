...
/obj/item/clothing/suit/toggle/labcoat/f13/khan
	...
	desc = "A black leather jacket. <br>There is an illustration on the back - an aggressive, red-eyed skull wearing a fur hat with horns. The skull has a mongoloid moustache - it's obviously a Great Khan emblem."
	icon_state = "khan"
...
/obj/item/clothing/suit/toggle/labcoat/f13/followers
	...
	desc = "A worn-down white labcoat with some wiring hanging from the right side.<br>Upon closer inspection, you can see dried bloodstains from long ago."
