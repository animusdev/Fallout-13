...
/obj/item/weapon/holodisk
	name = "holodisk"
	desc = "A durable laser-readable storage device produced by Wattz Electronics. Based on tape holography technology, it can store information safely for extended periods of time."
...
/obj/item/weapon/holodisk/runninggun
	desc = "A durable laser-readable storage device produced by Wattz Electronics. Based on tape holography technology, it can store information safely for extended periods of time.<br>This particular holodisk contains a rare Radio New Vegas broadcast.<br>An inscription on the side reads \"Running Gun\"."
	soundFile =  'sound/f13music/new_vegas_show_bonus_1.ogg'
	soundLength = 1836

/obj/item/weapon/holodisk/bigiron
	desc = "A durable laser-readable storage device produced by Wattz Electronics. Based on tape holography technology, it can store information safely for extended periods of time.<br>This particular holodisk contains a rare Radio New Vegas broadcast.<br>An inscription on the side reads \"Big Iron\"."
...
/obj/item/weapon/holodisk/musicbox
	name = "music box"
	desc = "A pre-War music box.<br>You wonder what song it plays."
	icon = 'icons/fallout/objects/items.dmi'
	icon_state = "music1"
	item_state = "music1"
